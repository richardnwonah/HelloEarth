...
namespace MockBankApi.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
       // private readonly StagingDbContext _context;
        ...
        // GET: api/Accounts
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Staging>>> GetStaging([FromQuery] AccountDateParameter dateParameter)
        {
            return  _accounts.GetAccountService(dateParameter);
        }
        ...
        // GET: api/Accounts/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Staging>> GetStaging(int id)
        {
